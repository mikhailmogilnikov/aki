...
export const Profile = () => {
  return (
    <ProfileProvider>
      <header
        className="flex gap-4 flex-col items-start max-lg:max-w-107 max-lg:px-4 max-lg:mx-auto lg:sticky lg:top-20 lg:h-fit lg:max-w-120 w-full"
        role="banner"
      >
        <EditAvatar
          className="size-46"
      ...
      <section className="w-full max-w-[428px] mx-auto px-[8px] lg:px-0">
        <BentoGrid />
      </section>
    </ProfileProvider>
  );

...
export const Profile = () => {
  ...
  return (
    <ProfileProvider>
      <header
        className="flex gap-4 flex-col items-start max-lg:max-w-116 max-lg:px-4 max-lg:mx-auto lg:sticky lg:top-20 lg:h-fit lg:max-w-120 w-full motion-opacity-in-0"
        role="banner"
      >
        <EditAvatar
          className="size-46"
